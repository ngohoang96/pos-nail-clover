...
export default class ModalNailsTechScreen extends Component {
  ...
  UNSAFE_componentWillMount() {
    this.props._onChangeStaffPinText('');
    Logg.info;
  }
  _onPressKey = key => {
  ...
  render() {
    ...
    return (
      <Modal
        ...
        <ScrollView
          contentContainerStyle={{width: '100%', height: Metrics.appHeight}}>
          <View
            style={{
              width: '100%',
              height: '100%',
            ...
            <View
              ...
              <Label onPressClose={this._onPressCancel} />
              <Input inputNailsTechClockIN={inputNailsTechClockIN} />
              <Keyboard
