...
const Actions = {
    ...
    updateCatnameService: newCatName => ({ type: Types.UPDATE_CATNAME_SERIVICE, payload: newCatName }),
    //cập nhật lại isSuccess của item list service , truyền vào item để lọc
    updateIssuccessItemService: item => ({ type: Types.UPDATE_ISSUCCESS_ITEM_SERVICE, payload: item }),
